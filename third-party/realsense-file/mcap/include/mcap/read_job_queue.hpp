...
#include <algorithm>
//#include <variant>
#include <third-party/realsense-file/mapbox/variant.hpp>
...
template< class >
constexpr bool always_false_v() { return false; }
 ...
 */
using ReadJob = mapbox::util::variant< ReadMessageJob, DecompressChunkJob >;
...
public:
    ...
    size_t len() const { return heap_.size(); }
};
