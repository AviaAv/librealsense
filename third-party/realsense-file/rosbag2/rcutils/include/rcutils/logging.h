...
#define RCUTILS_DEFAULT_LOGGER_DEFAULT_LEVEL RCUTILS_LOG_SEVERITY_INFO
     ...
     */
    typedef void ( *rcutils_logging_output_handler_t )( const rcutils_log_location_t *,  // location
                                                        int,                             // severity
                                                        const char *,                    // name
    ...
    RCUTILS_PUBLIC
    void
    rcutils_log( const rcutils_log_location_t * location, int severity, const char * name, const char * format, ... )
...
#define RCUTILS_LOGGING_AUTOINIT                                                                                       \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            RCUTILS_SAFE_FWRITE_TO_STDERR( "[rcutils|" __FILE__                                                        \
                                           ":" RCUTILS_STRINGIFY( __LINE__ ) "] error initializing logging: " );       \
            RCUTILS_SAFE_FWRITE_TO_STDERR( rcutils_get_error_string().str );                                           \
            RCUTILS_SAFE_FWRITE_TO_STDERR( "\n" );                                                                     \
            rcutils_reset_error();                                                                                     \
        }                                                                                                              \
    }
// Provide forward declaration for rcutils_log_internal used by macros and other C files.
RCUTILS_PUBLIC
